...
type OptionsIconType = {
  option: 'like' | 'delete' | 'check' | 'answer' | 'logo' | 'copy'
  type: 'svg'|'img'
  alt?: string
  className?: string
}

function Icon({option, type, alt, className}: OptionsIconType) {
  const options =  {
    like: {
      svg: 
      ...
      img: <img src={likeImg} alt={alt} className={className} />
    },
    delete: {
      svg: 
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      ,
      img: <img src={deleteImg} alt={alt} className={className} />
    },
    check: {
      svg: 
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      ,
      img: <img src={checkImg} alt={alt} className={className} />
    },
    answer: {
      svg: 
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      ,
      img: <img src={answerImg} alt={alt} className={className} />
    },
    logo: {
      svg: 
      ...
      ,
      img: <img src={logoImg} alt={alt} className={className} />
    },
    copy: {
      svg: 
      ...
      ,
      img: <img src={copyImg} alt={alt} className={className} />
    },
  }
